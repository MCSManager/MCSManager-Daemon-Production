...
// 注册临时任务护照
router_1.routerApp.on("passport/register", (ctx, data) => {
    ...
    if (!name || !password)
        throw new Error("不可定义任务名或密钥为空");
    mission_passport_1.missionPassport.registerMission(password, {
        name,
        parameter,
        count,
        start,
...
//# sourceMappingURL=passport_router.js.map