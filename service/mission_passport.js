...
exports.missionPassport = void 0;
// 任务护照管理器
class MissionPassport {
    ...
    // 注册任务护照
    registerMission(password, mission) {
    ...
    // 根据护照与任务名获取任务
    getMission(password, missionName) {
        if (!this.missions.has(password))
            return null;
    ...
    deleteMission(password) {
        this.missions.delete(password);
    }
}
const missionPassport = new MissionPassport();
exports.missionPassport = missionPassport;
//# sourceMappingURL=mission_passport.js.map